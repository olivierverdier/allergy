...
\itodo[Me]{Here is an inline todo of some urgent issue to address. The urgent todos are numbered.}

\itodo*[Me]{Another, less urgent task, with the starred version of the \texttt{\textbackslash itodo} command. This one is not numbered.}
